...
async function fetchMovie(item) {
    console.log('爬取的id为:'+item.doubanId);
...
;(async()=>{
    let movies=await Movie.find({$or:[{summary:{$exists:false}},{summary:null},{year:{$exists:false}},{title:""},{summary:""}]});
    console.log(movies,'我是数据')
